    ...
    <>
      <Box sx={{ ...sx.chart }} className="chart-container">
        ...
        <Box sx={sx['data-download']}>
          Download data: <DownloadBarData data={binnedData} fileType={'CSV'} /> /{' '}
          <DownloadBarData data={binnedData} fileType={'JSON'} />
        </Box>
      </Box>
    </>
  );
